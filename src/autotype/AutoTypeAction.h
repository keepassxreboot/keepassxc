...
public:
    ...
    virtual Result exec(TargetedAutoTypeExecutor* executor, QSharedPointer<AutoTypeTarget> target) = 0;
...
public:
    ...
    Result exec(TargetedAutoTypeExecutor* executor, QSharedPointer<AutoTypeTarget> target) override;
...
public:
    ...
    virtual AutoTypeAction::Result execType(AutoTypeKey* action, QSharedPointer<AutoTypeTarget> target) = 0;
    virtual AutoTypeAction::Result execClearField(AutoTypeClearField* action, QSharedPointer<AutoTypeTarget> target) = 0;
