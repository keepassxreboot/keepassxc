...
#ifndef KEEPASSX_AUTOTYPEEXTTESTINTERFACE_H
#define KEEPASSX_AUTOTYPEEXTTESTINTERFACE_H
...
{
public:
    virtual ~AutoTypeExtTestInterface()
    {
    }
...
Q_DECLARE_INTERFACE(AutoTypeExtTestInterface, "org.keepassx.AutoTypeExtTestInterface/1")

#endif // KEEPASSX_AUTOTYPEEXTTESTINTERFACE_H
