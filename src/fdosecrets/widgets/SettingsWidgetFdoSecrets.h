...
#ifndef KEEPASSXC_FDOSECRETS_SETTINGSWIDGETFDOSECRETS_H
#define KEEPASSXC_FDOSECRETS_SETTINGSWIDGETFDOSECRETS_H
...
#endif // KEEPASSXC_FDOSECRETS_SETTINGSWIDGETFDOSECRETS_H
