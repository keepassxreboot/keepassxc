...
void ApplicationSettingsWidget::loadSettings()
{
    ...
    m_generalUi->autocompleteSuggestionsCheckBox->setChecked(
        config()->get(Config::AutocompleteSuggestions).toBool());
...
void ApplicationSettingsWidget::saveSettings()
{
    ...
    config()->set(Config::AutocompleteSuggestions,
                  m_generalUi->autocompleteSuggestionsCheckBox->isChecked());
