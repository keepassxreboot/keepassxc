...
const QString DatabaseSettings::OPTION_ENABLE_CLIENT_RESTRICTIONS = QStringLiteral("BrowserEnableClientRestrictions");
...
bool DatabaseSettings::getClientRestrictions(const QSharedPointer<Database>& db)
{
    return getCustomDataOption(db, DatabaseSettings::OPTION_ENABLE_CLIENT_RESTRICTIONS) == TRUE_STR;
}

void DatabaseSettings::setClientRestrictions(const QSharedPointer<Database>& db, bool enabled)
{
