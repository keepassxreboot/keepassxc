...
public:
    ...
    bool getClientRestrictions(const QSharedPointer<Database>& db);
    void setClientRestrictions(const QSharedPointer<Database>& db, bool enabled);

    static const QString OPTION_ALLOW_GET_DATABASE_ENTRIES_REQUEST;
    static const QString OPTION_ALWAYS_ALLOW_ACCESS;
    static const QString OPTION_ENABLE_CLIENT_RESTRICTIONS;
