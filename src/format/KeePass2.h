...
namespace KeePass2
{
    ...
    extern const QString KDFPARAM_ARGON2_LANES;
    extern const QString KDFPARAM_ARGON2_MEMORY;
    extern const QString KDFPARAM_ARGON2_TIME;
    ...
    Kdf* paramsToKdf(const QVariantMap& p);
    Kdf* uuidToKdf(const Uuid& uuid);
    Uuid kdfToUuid(const Kdf& kdf);
    bool kdfToParams(const Kdf& kdf, QVariantMap& r);
}
