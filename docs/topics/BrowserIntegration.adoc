...
KeePassXC-Browser stores a list of websites you have previously allowed to connect to specific database entries. If you need to remove these remembered sites, follow these steps:
