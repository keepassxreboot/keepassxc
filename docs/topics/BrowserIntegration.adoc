...
KeePassXC-Browser stores a list of websites you have previously allowed to connect to specific database entries. To remove these remembered sites, you can enable the "Forget all site-specific settings on entries" feature in KeePassXC's browser integration. Follow these steps:
