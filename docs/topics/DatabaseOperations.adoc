...
==== Style
The Style page lets you customize the visual appearance of an entry. You can change the foreground and/or background color that this entry will use in the entry lists by enabling the corresponding checkbox and clicking the color button to open the color picker dialog.
