...
On platforms without a compatible hardware authenticator, KeePassXC offers a PIN-based Quick Unlock fallback. This lets you unlock a previously-opened database with a 6 to 10 digit PIN instead of your full master password. Entering the wrong pin 3 times will disable Quick Unlock and require you to unlock the database with your full credentials.
