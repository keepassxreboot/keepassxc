...
NOTE: On Windows, you will be prompted to authenticate to Windows Hello after unlocking your database with full credentials. This is required to access the hardware certificate store that secures Quick Unlock. If you cancel this prompt, your database will continue to unlock, but Quick Unlock will not be enabled.
