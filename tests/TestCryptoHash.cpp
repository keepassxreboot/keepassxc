...
void TestCryptoHash::test()
{
    ...
    QByteArray source2 = QLatin1String("KeePassX").latin1();
    ...
    cryptoHash3.addData(QLatin1String("KeePa").latin1());
    cryptoHash3.addData(QLatin1String("ssX").latin1());
    ...
    cryptoHash4.addData(QLatin1String("KeePa").latin1());
    cryptoHash4.addData(QLatin1String("ssX").latin1());
