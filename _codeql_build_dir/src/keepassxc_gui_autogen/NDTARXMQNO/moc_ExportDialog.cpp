...
#include <memory>
#include "../../../../src/gui/export/ExportDialog.h"
...
QT_MOC_LITERAL(1, 13, 12), // "exportFailed"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 6), // "reason"
QT_MOC_LITERAL(4, 34, 14) // "exportDatabase"

    },
    "ExportDialog\0exportFailed\0\0reason\0"
    "exportDatabase"
};
...
void ExportDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->exportFailed((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->exportDatabase(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ExportDialog::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ExportDialog::exportFailed)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ExportDialog::exportFailed(QString _t1)
{
