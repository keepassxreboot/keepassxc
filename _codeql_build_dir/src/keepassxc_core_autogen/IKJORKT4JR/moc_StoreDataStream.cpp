...
struct qt_meta_stringdata_StoreDataStream_t {
    QByteArrayData data[1];
    char stringdata0[16];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_StoreDataStream_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_StoreDataStream_t qt_meta_stringdata_StoreDataStream = {
    {
QT_MOC_LITERAL(0, 0, 15) // "StoreDataStream"
...
QT_INIT_METAOBJECT const QMetaObject StoreDataStream::staticMetaObject = { {
    QMetaObject::SuperData::link<LayeredStream::staticMetaObject>(),
    qt_meta_stringdata_StoreDataStream.data,
    qt_meta_data_StoreDataStream,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *StoreDataStream::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_StoreDataStream.stringdata0))
