...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Metadata_t, stringdata0) + ofs \
...
QT_INIT_METAOBJECT const QMetaObject Metadata::staticMetaObject = { {
    QMetaObject::SuperData::link<ModifiableObject::staticMetaObject>(),
    qt_meta_stringdata_Metadata.data,
